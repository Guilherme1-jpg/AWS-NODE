...
const pacientes = [
  { id: 1, nome: "Guilherme", dataNascimento: "2000-11-01" },
  { id: 2, nome: "Joaquim", dataNascimento: "1960-01-16" },
  { id: 3, nome: "Augusto", dataNascimento: "2012-06-06" },
];
...
module.exports.atualizarPaciente = async (event) => {  
  ...
  try {
    ...
    if (error == 'ConditionalCheckFailedException') {
      ...
      message = `O paciente com o ID ${pacienteId} não existe e não pode ser atualizado`;
      statusCode = 404;
    }
